		...
		var questions = [ // array of objects
			{
				...
				answers: ["1. <script>", "2. <javascript>", "3. <scripting>"],
				correctAnswer: "0"
			},
			{
				// question 1
				question: "How to write an IF statement in JavaScript?",
				answers: ["1. if i = 5 then", "2. if (i == 5)  ", "3. if i = 5"],
				correctAnswer: "1"
			},
			{
				// question 2
				question: "How does a WHILE loop start?",
				answers: ["1. while i = 1 to 10", "2. while (i <= 10; i++)", "3. while (i <= 10)"],
				correctAnswer: "2"
			},
			{
				// question 3
				question: "How can you add a comment in a JavaScript?",
				answers: ["1. <!--This is a comment-->", "2. //This is a comment", "3. 'This is a comment"],
				correctAnswer: "1"
			},
			{
				// question 4
